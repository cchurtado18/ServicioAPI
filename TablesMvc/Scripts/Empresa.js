...
function loadDtl(data) {
    ...
    $('#txtNombreEmpresa').val(data.NombreEmpresa);
    $('#txtNacionalidad').val(data.Nacionalidad);
    $('#modal-record').modal('toggle');
}

function Guardar() {
    var record = "'IdEmpresa':" + IdRecord;
    record += ",'NombreEmpresa':'" + $.trim($('#txtNombreEmpresa').val()) + "'";
    record += ",'Nacionalidad':'" + $.trim($('#txtNacionalidad').val()) + "'";
